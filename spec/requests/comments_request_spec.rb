...
RSpec.describe "Comments", type: :request do
  before(:each) do
    @user = User.create(name: "John Doe", photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Mexico.', posts_counter: 0)
    @post = @user.posts.create(title: "Hello World", text: 'This is my first post.', comments_counter: 0, likes_counter: 0)
